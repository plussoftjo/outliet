...
func CreateAdmin() {
	...
	if rolesCount == 0 {
		config.DB.Create(&models.Roles{
			Title:  "Admin",
			Pages:  "الإدخال,ادارة الموظفين,ادارة العيادات,الطلبات,التحويلات الداخلية,الطوارئ,الأحصائيات,التقارير",
			Scopes: "EntryMain,UserAdminMain,ClinicsMain,RequestsMain,ClinicsSection,EmergencyMain,Statics,Reports",
		})
